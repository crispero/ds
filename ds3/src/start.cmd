...
docker run --rm -e NATS_HOST=%NATS_HOST% -e NATS_PORT=%NATS_PORT% -e REDIS_HOST=%REDIS_HOST% -e REDIS_PORT=%REDIS_PORT% -e NATS_EVENT_BUS=%NATS_EVENT_BUS% --link %NATS_HOST% --link %REDIS_HOST% --name joblogger joblogger:%1